module.exports = (robot) ->
	...
	aloMessages = ["Har dere kontroll?", "Hvor er du?", "Er dere på saken?", "Det er du som har tatt roastbiffen, ja?", "Det er faktisk ganske interessant...", "Kan du sende meg en mail i forhold til det merkantile?"]
